  ...
  return (
    <>
      <div className="container  hero relative mx-auto  min-h-screen bg-base-200 py-16 ">
        <div className="hero-content w-full flex-col justify-between p-6  lg:flex-row">
          {/* section text */}
          <div className="absolute top-24 left-0 right-0 text-center ">
            <h1 className="text-3xl font-semibold text-primary xl:text-4xl">
              ABOUT ME
            </h1>
            <h2 className="text-md    opacity-80 xl:text-lg">
              learn more about me
            </h2>
          </div>
          {/* photo side */}
          ...
          <motion.div className="flex-1">
            ...
            <p className="pt-12 text-lg">
              ...
              consectetur adipisicing elit. Quisquam, quod. Lorem ipsum dolor
              sit
            </p>
          </motion.div>
        </div>
